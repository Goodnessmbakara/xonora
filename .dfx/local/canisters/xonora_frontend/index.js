...
import { idlFactory } from './xonora_frontend.did.js';
export { idlFactory } from './xonora_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_XONORA_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./xonora_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the xonora_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./xonora_frontend.did.js")._SERVICE>}
 */
export const xonora_frontend = createActor(canisterId);
