...
import { idlFactory } from './yieldbtc_frontend.did.js';
export { idlFactory } from './yieldbtc_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_YIELDBTC_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./yieldbtc_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the yieldbtc_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./yieldbtc_frontend.did.js")._SERVICE>}
 */
export const yieldbtc_frontend = createActor(canisterId);
