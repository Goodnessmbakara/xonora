...
import { idlFactory } from './xonora_backend.did.js';
export { idlFactory } from './xonora_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_XONORA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./xonora_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the xonora_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./xonora_backend.did.js")._SERVICE>}
 */
export const xonora_backend = createActor(canisterId);
