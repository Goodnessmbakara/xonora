...
import { idlFactory } from './yieldbtc_backend.did.js';
export { idlFactory } from './yieldbtc_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_YIELDBTC_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./yieldbtc_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the yieldbtc_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./yieldbtc_backend.did.js")._SERVICE>}
 */
export const yieldbtc_backend = createActor(canisterId);
