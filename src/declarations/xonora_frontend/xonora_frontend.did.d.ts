...
export interface XonoraFrontend {
  ...
  'create_chunks': ActorMethod<[{ 'content': (Uint8Array | number[])[]; 'batch_id': BatchId }], { 'chunk_ids': ChunkId[] }>;
  ...
  'get': ActorMethod<[{ 'key': Key; 'accept_encodings': string[] }], {
  ...
  'get_asset_properties': ActorMethod<[Key], {
    'headers': [] | [HeaderField[]];
    'is_aliased': [] | [boolean];
    'allow_raw_access': [] | [boolean];
    'max_age': [] | [bigint];
  ...
  'list_authorized': ActorMethod<[], Principal[]>;
  'list_permitted': ActorMethod<[ListPermitted], Principal[]>;
...
export interface _SERVICE extends XonoraFrontend {}
